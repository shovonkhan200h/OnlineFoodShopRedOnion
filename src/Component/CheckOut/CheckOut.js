        ...
        <Container className='my-5'>
            <Row>
                <Col>
                    ...
                    <form className='form-group' onSubmit={handleSubmit}>
                        <input className='form-control' name='fullName' value={formData.fullName} placeholder='Full Name' onChange={handleOnChange}></input>
                        <input className='form-control' name='road' value={formData.road} placeholder='Road' onChange={handleOnChange}></input>
                        <input className='form-control' name='postCode' value={formData.postCode} placeholder='Post Code' onChange={handleOnChange}></input>
                        <input className='form-control' name='town' value={formData.town} placeholder='Town' onChange={handleOnChange}></input>
                        <input className='form-control' name='country' value={formData.country} placeholder='Country' onChange={handleOnChange}></input>
                        <input className='form-control' name='mobile' value={formData.mobile} placeholder='Mobile' onChange={handleOnChange}></input> {/* removed the extra space from the field name */}
                ...
                <Col>
                    {cart.map(item => (
                        <div style={{ boxShadow: '0 5px 13px 0px rgb(210, 210, 210)', padding: '20px' }}>
            ...
            <Modal show={showModal} onHide={handleCloseModal}>
                ...
                <Modal.Footer>
                    ...
                    <Link><Button>Confrim</Button></Link>
                </Modal.Footer>
            </Modal>
        </Container>
    );
